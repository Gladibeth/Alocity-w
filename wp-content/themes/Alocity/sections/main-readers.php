    ...
    <div class="main-readers__content">
      ...
      <div class="main-readers__item">
        <div class="main-readers__img">
          <img src="<?php echo get_template_directory_uri(); ?>/assets/img/index/image_3.png">
        </div>
        <div class="main-check__btn">
          <a class="btn_custom btn--small btn--filled btn--filled--upper" href="<?php  echo bloginfo('url'); ?>/hardware">Check Out Our Door Readers</a>
        </div>
      </div>
      <div class="main-readers__item">
