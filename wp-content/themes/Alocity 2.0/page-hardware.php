<?php get_header(); ?>
<div class="main-banner banner-hard">
	<div class="main-banner__content">
		<div class="main-banner__item">
			<div class="main-banner__img main-banner__img--hard">
				<img src="<?php echo get_template_directory_uri(); ?>/assets/img/hardware/image-1.png">
			</div>
			...
			<div class="col-lg-4 col-12 p-0">
				<div class="content-control__img">
					<div class="main-control__img main-control__img--hard">
						<img src="<?php echo get_template_directory_uri(); ?>/assets/img/hardware/image-2.png">
					</div>
				</div>
			</div>
		</div>
	...
	<div class="container">
		<div class="row">
			<div class="main-infomation__img main-information__img--hard">
				<img src="<?php echo get_template_directory_uri(); ?>/assets/img/hardware/image-3.png">
			</div>
			...
			<div class="col-lg-6 col-xs-12 col-sm-6">
				<div class="main-information__content  main-information__content--height">
					...
					<div class="main-information__description main-information__description--left">
						<p>The AW series was designed with an IP-67 rated housing, ideal for extreme outdoor environments, working even under water, snow, dust, and humid conditions without compromising its efficiency and reliability.</p>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="main-access__item main-access__item--center ">
				...
				<div class="tab-content" id="pills-tabContent">
					<div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
						<div class="main-access__boximg">
							<div class="main-access__img">
								<img src="<?php echo get_template_directory_uri(); ?>/assets/img/hardware/galeria/1.png">
							</div>
					...
					<div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
						<div class="main-access__boximg">
							<div class="main-access__img">
								<img src="<?php echo get_template_directory_uri(); ?>/assets/img/hardware/galeria/1.1.png">
							</div>
							<div class="main-access__namecolor">
								<p>Black</p>
							</div>
			...
			<div class="main-access__item main-access__item--center ">
				...
				<div class="tab-content" id="pills-tabContent">
					<div class="tab-pane fade show active" id="pills-home1" role="tabpanel" aria-labelledby="pills-home1-tab">
						<div class="main-access__boximg">
							<div class="main-access__img">
								<img src="<?php echo get_template_directory_uri(); ?>/assets/img/hardware/galeria/2.2.png">
							</div>
							<div class="main-access__namecolor">
								<p> White</p>
							</div>
					...
					<div class="tab-pane fade" id="pills-profile1" role="tabpanel" aria-labelledby="pills-profile1-tab">
						<div class="main-access__boximg">
							<div class="main-access__img">
								<img src="<?php echo get_template_directory_uri(); ?>/assets/img/hardware/galeria/2.png">
							</div>
							<div class="main-access__namecolor">
								<p>Black</p>
							</div>
			...
			<div class="main-access__item main-access__item--center ">
				...
				<div class="tab-content" id="pills-tabContent">
					<div class="tab-pane fade show active" id="pills-home2" role="tabpanel" aria-labelledby="pills-home2-tab">
						<div class="main-access__boximg">
							<div class="main-access__img">
								<img src="<?php echo get_template_directory_uri(); ?>/assets/img/hardware/galeria/3.3.png">
							</div>
							<div class="main-access__namecolor">
								<p> Black</p>
							</div>
					...
					<div class="tab-pane fade" id="pills-profile2" role="tabpanel" aria-labelledby="pills-profile2-tab">
						<div class="main-access__boximg">
							<div class="main-access__img">
								<img src="<?php echo get_template_directory_uri(); ?>/assets/img/hardware/galeria/3.png">
							</div>
							<div class="main-access__namecolor">
								<p>White</p>
							</div>
			...
			<div class="main-access__item main-access__item--center ">
				...
				<div class="tab-content" id="pills-tabContent">
					<div class="tab-pane fade show active" id="pills-home3" role="tabpanel" aria-labelledby="pills-home3-tab">
						<div class="main-access__boximg">
							<div class="main-access__img">
								<img src="<?php echo get_template_directory_uri(); ?>/assets/img/hardware/galeria/4.png">
							</div>
							<div class="main-access__namecolor">
								<p> Black</p>
							</div>
					...
					<div class="tab-pane fade" id="pills-profile3" role="tabpanel" aria-labelledby="pills-profile3-tab">
						<div class="main-access__boximg">
							<div class="main-access__img">
								<img src="<?php echo get_template_directory_uri(); ?>/assets/img/hardware/galeria/4.4.png">
							</div>
							<div class="main-access__namecolor">
								<p>White</p>
							</div>
