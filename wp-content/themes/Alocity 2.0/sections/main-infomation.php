        ...
        <div class="col-lg-6 col-xs-12 col-sm-6">
          <div class="main-information__content ">
            ...
            <div class="main-information__description">
              <p>Let one of our specialists help you</p>
            </div>
            <div class="main-information__btn">
              <a class="btn_custom btn--medium btn--filled--white"  href="" data-target="#get_quate" data-toggle="modal">get a quote</a>
            </div>
            <div class="main-information__description">
              <p>Contact us 888-512-2115</p>
            </div>
          </div>
        </div>
      </div>
