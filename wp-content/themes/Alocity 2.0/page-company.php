  ...
  <div class="main-banner">
    <div class="main-banner__content">
      <div class="main-banner__item">
        <div class="main-banner__img main-banner__img-company">
              ...
              <div class="main-banner__boxtext">
                <div class="main-banner__text main-banner__text--company">
                  ...
                  <div class="main-banner__description main-banner__description--company">
                    <p>We are set out to make our customer's lives more simpler and secure by offering unprecedented visibility and control over their doors and facilities. Our solutions are designed to efficiently manage door access control, video surveillance,
            ...
            <div class="col-lg-6 col-md-6 col-12">
              <div class="main-banner__imags">
                <div class="main-banner__imags--one">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/img/company/image-1.png">
                </div>
        ...
        <div class="main-company__boximg">
          ...
          <div class="main-company__imgs">
            <div class="main-company__imgs--one">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/img/company/image-2.png">
            </div>
        ...
        <div class="main-company__boximg">
          ...
          <div class="main-company__imgs">
            <div class="main-company__imgs--one main-company__imgs--pad">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/img/company/image-3.png">
            </div>
          </div>
        </div>
      </div>
